            ...
            events: {
                mounted: function (ctx, config) {
                    ...
                    ctx.addPointAnnotation({
                        ...
                        customSVG: {
                            SVG: '<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="#088dcd" stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg>',
                            cssClass: undefined,
                            offsetX: -8,
                            offsetY: 5,
                        },
...
try {
    ...
    */
    ...
    // total downloads
    d_1C_2 = new ApexCharts(document.querySelector("#total-downloads"), spark3);
    d_1C_2.render();
    ...
    var d_1C_5 = new ApexCharts(
        document.querySelector("#hybrid_traffic"),
        d_1options6
    );
    d_1C_5.render();
