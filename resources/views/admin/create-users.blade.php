            ...
            <div class="col-lg-12">
                <div class="panel-content">
                    ...
                    <div class="row merged20 mb-4">
                        <div class="col-lg-12">
                            <div class="d-widget">
                                <form method="post" enctype="multipart/form-data" action="/administrator/users">
                                    @csrf
                                    ...
                                    <div class="uk-text-center" uk-grid>
                                        <div class="uk-width-expand@m">
                                            <fieldset class="uk-fieldset mt-3">
                                                <div class="uk-margin">
                                                    <input class="uk-input" name="fullname" id="fullname" type="text"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="uk-margin">
                                                            <input class="uk-input" name="password" id="password"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="uk-margin">
                                                            <input class="uk-input" name="address" id="address"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="uk-margin">
                                                            <input class="uk-input" name="phone" id="phone"
