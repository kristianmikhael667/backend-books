                        ...
                        <div class="col-lg-12">
                            <div class="d-widget">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        @forelse ($members as $num => $member)
                                        <tr>
                                            <td>{{ $num+1 }}</td>
                                            <td>{{ $member->members->fullname }}</td>
                                            <td>{{ $member->number_card }}</td>
                                            <td>{{ $member->phone }}</td>
                                            <td>{{ $member->status_member }}</td>
                                            <td>{{ \Carbon\Carbon::parse($member->created_at)->diffForHumans() }}
                                            </td>
                                            <td>
                                                <a href="#" data-toggle="modal" data-target="#view_{{$member->id}}"
                                                ...
                                                @include('modal.member')

                                                <a href="/dashboard/posts/{{ $member->uid }}/edit"
                                                ...
                                                <form action="/administrator/post/{{ $member->uid }}" method="post"
                                                    class="d-inline">
                                                    @method('delete')
                                                    @csrf
