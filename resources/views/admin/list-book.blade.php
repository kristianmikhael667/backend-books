                        ...
                        <div class="col-lg-12">
                            <div class="d-widget">
                                ...
                                <div class="d-widget-title">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            <form action="/administrator/books" method="get" role="search">
                                                <div class="input-group">
                                                    @if (request('category'))
                                                    <input type="text" class="form-control" name="search"
                                                        placeholder="Search Title books ..."
                                ...
                                <div style="overflow-x: auto">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            @forelse ($books as $num => $book)

                                            <tr>
                                                <td>{{ $books->firstItem() + $num }}</td>
                                                <td>{{ $book->title_book }}</td>
                                                <td>{{ $book->qtybook->qty }}</td>
                                                <td>{{ $book->catalog->name_catalog }}</td>
                                                <td>{{ $book->author_book }}</td>
                                                <td>{{ $book->publish_book }}</td>
                                                <td>{{ $book->publish_date }}</td>
                                                <td>{{ $book->status_book }}</td>
                                                <td>
                                                    <a href="/administrator/books/{{$book->slug}}/edit"
